 ...
 * ResearchStack ViewTaskActivity to ask the user for their answers, so the ViewTaskActivity has to
 * be declared in the android manifest. Fragments need to be added to the fragmentmanager of the
 * parent acitivity.
 */
